...
-- Medicine.IsActive: soft-delete flag. Deactivating keeps the row and all OrderItem FKs.
-- Existing DBs (do not re-run full script): 
--   IF COL_LENGTH('dbo.Medicine', 'IsActive') IS NULL
--     ALTER TABLE Medicine ADD IsActive BIT NOT NULL
...
INSERT INTO Medicine (
    ...
    Description, ActiveIngredient, UsageInstructions, Warnings, SideEffects, PackSize, IsActive)
VALUES
