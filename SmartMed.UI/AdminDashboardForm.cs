...
namespace SmartMed.UI
{
    public partial class AdminDashboardForm : Form
    {
        ...
        private void BuildDashboardContent()
        {
            ...
            lblWelcome.Text = $"Welcome, {Session.CurrentAdmin?.Username}";
            ...
            trendsBody.Controls.Add(lblTrend);

            panelContent.Controls.Add(trendsOuter);
            panelContent.Controls.Add(middleRow);
            panelContent.Controls.Add(statsRow);
        ...
        private Panel CreateStatCard(string iconGlyph, string title, Label valueLabel, string subtitle)
        {
            ...
            card.Controls.AddRange(new Control[] { icon, lblTitle, valueLabel, lblSub });
            return card;
        }
        ...
        private Panel CreateQuickFulfillmentPanel()
        {
            ...
            btn.Click += (s, e) => ShowComingSoon("Manage Orders");
        ...
        private Panel CreateAlertRow(string name, string message, bool critical)
        {
            var row = new Panel
            {
                Width = panelAlerts.ClientSize.Width - 24,
                Height = 52,
                Margin = new Padding(0, 0, 0, 8),
