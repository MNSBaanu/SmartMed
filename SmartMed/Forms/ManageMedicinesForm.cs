...

    {
...

        {
...

            {
                ...
                new { MedicineID = 1, MedicineName = "Amoxicillin 500mg", Category = "Antibiotic", Dosage = "500mg Caps", Price = "14.50", Stock = 120, Supplier = "MediDist Ltd", Expiry = "2025-12-01", Rx = "\u2713", Discount = "0%", Promo = "No" },

                new { MedicineID = 2, MedicineName = "Lisinopril 10mg", Category = "Hypertension", Dosage = "10mg Tablets", Price = "8.20", Stock = 45, Supplier = "Global Pharma", Expiry = "2024-08-15", Rx = "\u2713", Discount = "10%", Promo = "Yes" },

                new { MedicineID = 3, MedicineName = "Ibuprofen 200mg", Category = "Analgesic", Dosage = "200mg Softgels", Price = "5.99", Stock = 12, Supplier = "OTC Supply Co", Expiry = "2026-01-30", Rx = "\u2717", Discount = "0%", Promo = "No" }
            ...
            lblExpiryAlerts.Text = "1 expired, 2 expiring within 30 days.";
...

        {
            ...
            var filtered = _medicines.Search(txtSearch?.Text ?? string.Empty, category, minPrice, maxPrice);
...

        {
            ...
            lblCompliance.Text = $"{_medicines.CompliancePercent(all):N1}%";
...

        {
            ...
            var item = _medicines.GetById(_selectedId.Value);
...

        {
...

            {
                ...
                var items = _medicines.Search(txtSearch?.Text ?? string.Empty, category, minPrice, maxPrice);
